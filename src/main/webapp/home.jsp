                                ...
                                <div class="row">
                                    <div class="col-lg-6 banner-info-bg">
                                        ...
                                        <a class="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="#book"> Book a
                                            card</a>
                                        <a class="btn btn-style btn-outline-light mt-sm-5 mt-4 mr-2" href="about.jsp">
                                            Read More</a>
                                    </div>
                                    <div class="col-lg-5 col-md-8 img offset-lg-1 mt-lg-0 mt-4">
                                        <img src="assets/images/card1.jpg" alt="img"
                        ...
                        <div class="banner-info">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-8 img offset-lg-1 mt-lg-0 mt-4">
                                        <img src="assets/images/card3.jpg" alt="img"
                                            class="img-fluid radius-image-curve" />
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row">
                <div class="col-lg-7 mb-lg-0 mb-md-5 mb-4 align-self">
                    ...
                    <a class="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="about.jsp"> Learn More</a>
                </div>
                <div class="col-lg-5">
