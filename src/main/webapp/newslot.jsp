...
<body>
    <div id="block" class="w3lvide-content" data-vide-bg="assets/images/slot" data-vide-options="position: 0% 50%">
        <div class="wrapper">
            <div class="workinghny-form-grid">
                <div class="slot-w3l-comingsoon">
                    <div class="slot-w3content">
                        <h3>Coming Soon!</h3>
                        <h1>Our New Offers <br>for Domestic Users</h1>
                        ...
                        <form action="https://sendmail.w3layouts.com/submitForm" method="post" class="signin-form">
                            <div class="input-grids">
                              <input type="text" name="w3lName" id="w3lName" placeholder="Your Name :" class="contact-input" autofocus
                                required="" />
                              <input type="email" name="w3lSender" id="w3lSender" placeholder="Your Email :" class="contact-input" autofocus
                                required="" />
                                <textarea name="w3lMessage" id="w3lMessage" placeholder="Enter Message :" required="" autofocus></textarea>
                        </div>
           ...
           <div class="copyright text-center">
            <p class="copy-footer-29"> Michael Bank � | All rights reserved</p>
           </div>
         <!-- //copyright-->
        </div>
    </div>
